          ...
          <div className="flex flex-col md:flex-row gap-4">
                ...
                <table className="w-full ">
                  <thead>
                    <tr>
                      ...
                      <th className="text-left font-semibold">Dates</th>
                        ...
                        return (
                          <tr key={item._id}>
                            ...
                            <td className="py-4 flex pt-8 gap-2">
                              ...
                              className="px-3 py-1 cursor-pointer bg-red-500 rounded-3xl 
                              ...
                              text-white font-bold"><FiDollarSign className="mr-2"/></button>
                            </td>
                          </tr>
                        );
                      })
            ...
            <div className="md:w-1/5 fixed right-3">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <button disabled={price <= 0 } onClick={()=>navigate("/dashboard/user/payment",{state : {price:price,itemId : null}})} 
                className="bg-secondary text-white py-2 px-4 rounded-lg mt-4 w-full">Checkout</button>
              </div>
            </div>
          </div>
        </div>
